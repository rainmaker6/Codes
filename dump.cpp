...
const int MAXN = 1e4;
int  boss [ MAXN ] , ans;
vector< int > v , empoloye [ MAXN ];
int get_empoloye( int a)
{
           int ans2 = 0;
           for(int i = 0 ; i < empoloye [ a ].size() ; i++)
                      ans2 = max(get_empoloye(empoloye[ a ][ i ]) , ans2);
           return ans2 + 1;
}
int main() {
           ...
           for(int i = 0 ; i < n ; i++)
           {
                      ...
                      if(a == -1)
                      {
                                 ...
                                 boss [ i + 1 ] = a;
                                 empoloye [ a ].push_back( i + 1) ;
                      }
           }
           for(int i = 0 ; i < v.size() ;i++ )
                      ans = max(ans , get_empoloye(v [ i ]));
           cout << ans;
}
////////////////////////////////////////////////////////////////////////////
