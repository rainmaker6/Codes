== image:../../../../boost.png[image]Sparse Matricies
...
non-zero elements __m__~_i, j_~ are mapped via _(i x n + j)_ for row
...
= __m__~__i__~_1_~~ ~__,j__~_1_~~and __k + 1 = m__~__i__~_2_~~
~__,j__~_2_~~of the container holds __i__~_1_~ __< i__~_2_~ or
...
elements _k_ = __m__~__i__~_1_~~ ~__,j__~_1_~~and __k + 1 =
m__~__i__~_2_~~ ~__,j__~_2_~~of the container holds __i__~_1_~ __<
